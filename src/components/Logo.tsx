/** The hartebeest mark: long face with the dark blaze and bracket shaped horns. */
export function Logo({ size = 48, label = 'Hartebeesvlakte logo' }: { size?: number; label?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" role="img" aria-label={label} style={{ flexShrink: 0 }}>
      <rect width="100" height="100" rx="24" fill="#A94A24" />
      <g fill="none" stroke="#F6EAD7" strokeWidth="6.5" strokeLinecap="round">
